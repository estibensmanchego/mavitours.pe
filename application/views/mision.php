		...
		<div class="subheader">
			<div class="left">
				<span class="page-title">Misión</span>
			...
			<div class="two-third">
				...
				<div class="post-item post-blog">
					...
					<div class="post-content">
						<h2 class="post-title">Nuestra Misión</h2>
						<p>Ofrecer una atención de calidad en el servicio turístico, brindando un trato personalizado y profesional. Donde el usuario se sienta seguro,  cómodo y  cuya única preocupación sea disfrutar y compartir esta experiencia.</p>
					</div>
					<div class="post-meta">
					</div>						
				</div>
